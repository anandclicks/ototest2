...
function Listproperty() {
  ...
  return (
    ...
    <i onClick={prev => setFormstate(!prev)} class="fa-regular fa-xmark position-absolute end-0 top-0 m-3 m-lg-5 cursur p24px cursor-pointer fw-bold closeAddPropertyForm text-black"></i>
      <h2 class="text-center p24px fwnormal">Add property</h2>
