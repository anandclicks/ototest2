...
function PGListings() {
  return (
    <div>
      ...
      <div className="row">
      <Link to={'/pg-in-noida/Oto-royalwin-sec104'} className="col-md-3 mb-4 cursor-pointer Pgcard">
        ...
        <Link to={'/pg-in-noida/Oto-bloom-sec45'} className="col-md-3 mb-4 cursor-pointer Pgcard">
          <div className="cardimg">
            <div className='cardImg'>
        ...
        <Link to={'/pg-in-noida/Oto-royaltown-sec45'} className="col-md-3 mb-4 cursor-pointer Pgcard">
          <div className="cardimg">
            <div className='cardImg'>
        ...
        <Link to={'/pg-in-noida/Oto-capital-sec44'} className="col-md-3 mb-4 cursor-pointer Pgcard">
          <div className="cardimg">
            <div className='cardImg'>
