  ...
  return (
    ...
    <div className='container-flued  p-0'>
      <div className="row h-100 p-0">
        ...
        <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/components\Allcitiesindividualpgs\otocapitalsec44\IMG-20230806-WA0006.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/components\Allcitiesindividualpgs\otocapitalsec44\IMG-20230806-WA0010.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/components\Allcitiesindividualpgs\otocapitalsec44\IMG-20230806-WA0013.jpg" alt="" /></div>
          <div className="col-12 col-lg-3 overflow-hidden p-0 h-full"><img className='h-full w-full object-cover ' src="/components\Allcitiesindividualpgs\otocapitalsec44\IMG-20230806-WA0016.jpg" alt="" /></div>
        </div>
