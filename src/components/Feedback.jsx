...
function Feedback() {
  return (
    <div className='container-flued h60 primeryBg'>
      <div className="row row2 pt-2 pt-lg-4 justify-center">
        <h1 className='text-uppercase text-center m-0'>Custumer Reviews</h1>
