      ...
      <div className="col-12 col-lg-6 d-flex justify-content-start justify-content-lg-between">
        <div className="hotel-details d-flex flex-column justify-content-start justify-content-lg-between">
          <div className="w-100 my- my-lg-2">
            <h2 className="p24px fw-bold">Lorem ipsum dolor sit amet.</h2>
            <p className='p24px'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi, quod.</p>
          </div>
          <Amentiesmini/>
          <div className="prices w-100 my- my-lg-2">
           
            <p className="price my-2 my-lg-0 p24px">₹11,000 <span className="original-price">₹16,000</span> 31% off</p>
          </div>
        </div>
